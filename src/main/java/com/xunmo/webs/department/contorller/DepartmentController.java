package com.xunmo.webs.department.contorller;
...
@Controller
@Mapping("/department")
public class DepartmentController extends XmSimpleMoveController<DepartmentService, Department> implements IDepartmentController{
